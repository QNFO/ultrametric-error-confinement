...
- Companion paper: 0.8.md — Symmetric Extension of Ultrametric Error Confinement.
- Platform scoping: 0.6.md — Physical Implementation Pathway.
- Outreach whitepaper: 0.7.md — One-Page Summary for Experimentalists.
