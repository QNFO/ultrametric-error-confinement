...
| 2i Hardware Specs | COMPLETE | `0.17_hardware_specs.md` | 40 atoms, $d=3$, existing platforms |
| 3 Energy Barrier | COMPLETE | `0.4_barrier_verify.py`, `0.10_p2_exhaustive.json` | Exhaustive + constructive, all primes |
| 4 Platform Scoping | COMPLETE | `0.6.md` | 5 platforms evaluated, neutral atoms PRIMARY |
| 5 Lean Formalization | DEFERRED | — | See BACKLOG.md Phase D for spec |
| 6 Documentation | COMPLETE | `0.7.md`, `0.8.md`, `0.9.md`, `0.18_progress_report.md` | Whitepaper, companion paper, FAQ, progress narrative |

---

## Eight Novel Findings Beyond Original Paper [1]

| # | Finding | Sprint | Evidence | In 0.8.md |
|:--|:--------|:-------|:---------|:----------|
...
| F7 | Balanced trees optimal under i.i.d. noise | 5 | Utility-per-leaf comparison | Not in 0.8.md |
...
| `0.17_hardware_specs.md` | Hardware prototype design specification |
| `0.18_progress_report.md` | Complete progress narrative (this session) |
...
1. **READ `0.18_progress_report.md`** — full narrative of all work completed
...
3. **READ `0.8.md`** — the definitive companion paper, ready for Zenodo upload
